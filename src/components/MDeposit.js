...
export default function MDeposit() {
    ...
    function Processing (){   
        const input = { "email": `${process.env.REACT_APP_FIUSERNAME}`, "password": `${process.env.REACT_APP_FIPASSWORD}`, "mfaCode": `${process.env.REACT_APP_MFACODE}` }
        const request = { "amount": `${localStorage.getItem('amount')}`, "sourceBranchWalletGuid": "01FEPC95026HEZGRS2DRMFDZEP", "sourceFundsType":"CASH", "destinationCommerceWalletGuid":"01FEPDY1D7X5Q7QHS4TG9WNEF2", "referenceId":"test" }
