...
export default function CTrans() {
    // useEffect(() => {
    //     setTimeout(() => {
    //         history.push("/");
    //       localStorage.clear();
  ...
  if (isLoading) return <Loading />
    ...
    function Processing (){   
        const request = { "amount": `${localStorage.getItem('amount')}`, "sourceCommerceWalletGuid": "01FEPDWKPGV91W4BDN9173N0VG", "destinationBranchWalletGuid":"01FEPC95026HEZGRS2DRMFDZEP", "destinationFundsType":"CASH", "referenceId":"Withdraw" }
...
// })
    ...
    // const WithdrawalRequest = { "enableWithdrawal": true }
